"""Process transcript.json files in transcribe.rightcall s3 bucket
    into comprehend and store results in comprehend.rightcall s3 bucket.
    Without having to actually re-run the transcribe job which takes ages"""
